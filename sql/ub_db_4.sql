...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2021 at 01:51 PM
...
INSERT INTO `destinations` (`destination_id`, `name`, `coordx`, `coordy`, `description`, `price`, `type`, `regions`, `weather`) VALUES
(1, '123', '123', '123', '123', '123', 'adventourous', 'punjab', 'hot'),
(2, '123', '123', '123', '123', '123', 'adventourous', 'sindh', 'cool'),
(3, '123', '123', '123', '123', '123', 'adventourous', 'kpk', 'normal'),
(4, '123', '123', '123', '123', '123', 'adventourous', 'baluchistan', 'hot'),
(5, '[value-2]', '[value-3]', '[value-4]', '[value-5]', '[value-6]', 'religious', 'punjab', 'cool'),
(6, 'yahya', '123', '123', '123', '123', 'religious', 'sindh', 'normal'),
(7, 'ammar', '456', '345', 'description', '999', 'historical', 'kpk', 'hot');
...
INSERT INTO `destination_reviews` (`dr_id`, `destination`, `review`) VALUES
(1, 1, 3),
(2, 1, 4),
(3, 2, 1),
(4, 2, 2);
...
INSERT INTO `destination_videos` (`id`, `destination`, `video`) VALUES
(1, 1, 7),
(2, 1, 6),
(3, 1, 5),
(4, 1, 4),
...
INSERT INTO `reviews` (`review_id`, `type`, `text`, `rating`, `author`, `email`) VALUES
(1, 'destination', 'it is a good place blah blah blah', 4.5, 'yahya', 'yahyaammar4807@gmail.com'),
(2, 'qweqweqwe', 'qwe wqe a qwe wqe blah wqe qwe', 3, 'yahya', 'qweqewwqe@gmail.com'),
(3, 'asdasdasd', 'asd asd a asd asd asd wqe asd', 2, 'asd', 'asdsasdads@gmail.com'),
(4, 'destination', 'loreum ipsum is text', 1.5, 'khan', 'muhammadali@gmail.com');
...
(1, 'https://www.youtube.com/embed/_1KVl5bZF30'),
(2, 'https://www.youtube.com/embed/_1KVl5bZF30'),
(3, 'https://www.youtube.com/embed/_1KVl5bZF30'),
(4, 'https://www.youtube.com/embed/_1KVl5bZF30'),
(5, 'https://www.youtube.com/embed/_1KVl5bZF30'),
(6, 'https://www.youtube.com/embed/_1KVl5bZF30'),
(7, 'https://www.youtube.com/embed/_1KVl5bZF30');
...
--
ALTER TABLE `destination_reviews`
  ADD CONSTRAINT `destination_reviews_ibfk_1` FOREIGN KEY (`destination`) REFERENCES `destinations` (`destination_id`),
...
--
ALTER TABLE `destination_videos`
  ADD CONSTRAINT `destination_videos_ibfk_1` FOREIGN KEY (`video`) REFERENCES `videos` (`id`);
