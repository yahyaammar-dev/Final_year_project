<div class="formContainer">
    <form action="" method="POST" class="form">
        ...
        <div class="item">
            ...
            <input class="form__input" type="text" placeholder="Enter Your Email"><br><br>
        </div>
        <label class="form__label item" for="name">Password</label>
        <div class="item">
            <i class="fas fa-unlock-alt form__icon"></i>
            <input class="form__input" type="text" placeholder="Enter Your Password"><br><br>
        </div>   
        <label class="form__label item" for="name">Phone</label>
        <div class="item">
            <i class="fas fa-phone form__icon"></i>
            <input class="form__input" type="text" placeholder="Enter Your Phone Number"><br><br>
        </div>
