...
<div class="listing__main">
    ...
    <?php
        for($i=0; $i<count($abc["hotel"]); $i++){    
    ?>
<script>
    var id = '<?php echo  $abc["hotel"][$i]['id']; ?>';
    $.ajax({
...
<div class="block">
    ...
    <div class="block__info">
        <p class="blocks__id"><?php echo $abc["hotel"][$i]["id"]; ?></p>
        <p class="blocks__title"><?php echo $abc["hotel"][$i]["name"];   ?></p>
        <p class="blocks__price"> <?php       echo $abc["hotel"][$i]["description"];   ?></p>
        <p class="blocks__category"> <?php       echo $abc["hotel"][$i]["price"];   ?></p>
        <p class="blocks__region"> <?php       echo $abc["hotel"][$i]["phone"];   ?></p>
